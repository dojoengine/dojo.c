...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_dojo_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_dojo_rustbuffer_free(self, $0) }
    }
}
...
public struct Achievement: Equatable, Hashable {
    ...
    public var worldAddress: FieldElement
    ...
    public var tasks: [AchievementTask]
    public var data: String?
    public var totalCompletions: UInt32
...
public struct AchievementProgression: Equatable, Hashable {
    ...
    public var worldAddress: FieldElement
    public var namespace: String
    public var playerId: FieldElement
...
public struct AchievementQuery: Equatable, Hashable {
    public var worldAddresses: [FieldElement]
...
public struct Activity: Equatable, Hashable {
    ...
    public var worldAddress: FieldElement
    public var namespace: String
    public var callerAddress: FieldElement
    public var sessionStart: UInt64
    public var sessionEnd: UInt64
    public var actionCount: UInt32
    public var actions: [ActionCount]
    public var updatedAt: UInt64
...
public struct ActivityQuery: Equatable, Hashable {
    public var worldAddresses: [FieldElement]
    public var namespaces: [String]
    public var callerAddresses: [FieldElement]
    public var fromTime: UInt64?
    public var toTime: UInt64?
    public var pagination: Pagination
...
public struct CompositeClause: Equatable, Hashable {
    public var `operator`: LogicalOperator
...
public struct Contract: Equatable, Hashable {
    ...
    public var tps: UInt64?
    public var lastBlockTimestamp: UInt64?
    public var lastPendingBlockTx: FieldElement?
    public var updatedAt: UInt64
    public var createdAt: UInt64
...
public struct ContractQuery: Equatable, Hashable {
    public var contractAddresses: [FieldElement]
    public var contractTypes: [ContractType]
...
public struct Controller: Equatable, Hashable {
    public var address: FieldElement
    public var username: String
    public var deployedAtTimestamp: UInt64
...
public struct EnumType: Equatable, Hashable {
    public var name: String
    public var option: UInt8
    public var options: [EnumOption]
...
public struct KeysClause: Equatable, Hashable {
    public var keys: [FieldElement?]
    public var patternMatching: PatternMatching
...
public struct PlayerAchievementEntry: Equatable, Hashable {
    public var playerAddress: FieldElement
    public var stats: PlayerAchievementStats
    public var achievements: [PlayerAchievementProgress]
...
public struct PlayerAchievementQuery: Equatable, Hashable {
    public var worldAddresses: [FieldElement]
    public var namespaces: [String]
    public var playerAddresses: [FieldElement]
    public var pagination: Pagination
...
public struct PlayerAchievementStats: Equatable, Hashable {
    public var totalPoints: UInt32
    public var completedAchievements: UInt32
    public var totalAchievements: UInt32
    public var completionPercentage: Double
    public var lastAchievementAt: UInt64?
    public var createdAt: UInt64
    public var updatedAt: UInt64
...
public struct Signature: Equatable, Hashable {
    public var r: FieldElement
    public var s: FieldElement
...
public struct Token: Equatable, Hashable {
    public var contractAddress: FieldElement
    public var tokenId: U256?
    public var name: String
    public var symbol: String
    public var decimals: UInt8
    public var metadata: String
    public var totalSupply: U256?
...
public struct TokenBalance: Equatable, Hashable {
    ...
    public var accountAddress: FieldElement
    public var contractAddress: FieldElement
    public var tokenId: U256?
...
public struct TokenBalanceQuery: Equatable, Hashable {
    public var contractAddresses: [FieldElement]
    public var accountAddresses: [FieldElement]
    public var tokenIds: [U256]
    public var pagination: Pagination
...
public struct TokenContract: Equatable, Hashable {
    ...
    public var decimals: UInt8
    public var metadata: String
    public var tokenMetadata: String
    public var totalSupply: U256?
...
public struct TokenTransfer: Equatable, Hashable {
    public var id: String
    public var contractAddress: FieldElement
    public var fromAddress: FieldElement
    public var toAddress: FieldElement
    public var amount: U256
    public var tokenId: U256?
    public var executedAt: UInt64
...
public struct Transaction: Equatable, Hashable {
    public var transactionHash: FieldElement
    public var senderAddress: FieldElement
    public var calldata: [FieldElement]
    public var maxFee: FieldElement
    public var signature: [FieldElement]
    public var nonce: FieldElement
    public var blockNumber: UInt64
    public var transactionType: String
    public var blockTimestamp: UInt64
    public var calls: [TransactionCall]
    public var uniqueModels: [FieldElement]
...
public struct TransactionFilter: Equatable, Hashable {
    public var transactionHashes: [FieldElement]
    public var callerAddresses: [FieldElement]
    public var contractAddresses: [FieldElement]
    public var entrypoints: [String]
    public var modelSelectors: [FieldElement]
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_dojo_uniffi_contract_version()
...
public func uniffiEnsureDojoInitialized() {
